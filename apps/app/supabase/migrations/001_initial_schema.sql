-- =========================================================================
-- ZYLOS HYBRID MERGE: CORE SCHEMA (001_initial_schema)
-- Taking core schema from migrations + enhanced structure
-- =========================================================================
...
-- Tenants table - Enhanced with additional fields from migra-comparar
CREATE TABLE tenants (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    name VARCHAR(100) NOT NULL,
    subdomain VARCHAR(50) UNIQUE NOT NULL,
    active BOOLEAN DEFAULT true, -- From migra-comparar 005
...
CREATE INDEX idx_tenants_active ON tenants(active); -- From migra-comparar
CREATE INDEX idx_tenants_subdomain ON tenants(subdomain); -- From migra-comparar
