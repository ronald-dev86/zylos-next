...
export class QueryError extends RepositoryError {
  constructor(query: string, originalError?: Error) {
    super('execute query', 'database', originalError)
    this.details = { query, originalError: originalError?.message }
  }
}
...
export class PaymentGatewayError extends ExternalServiceError {
  constructor(gateway: string, transactionId?: string, originalError?: Error) {
    ...
    this.details = { gateway, transactionId }
  }
}
...
export class EmailServiceError extends ExternalServiceError {
  constructor(provider: string, operation: string, originalError?: Error) {
    super(`Email service '${provider}'`, operation, originalError)
  }
}
